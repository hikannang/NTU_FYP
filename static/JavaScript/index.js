...
function selectGreen(){
    ...
    if (document.getElementById('greenOff')){ 
        ...
        content.innerHTML = '<a-entity id="green" gltf-model="./static/3dModels/GLB/location2.glb" scale="0.01 0.01 0.01" gps-projected-entity-place="latitude: 1.4015849; longitude: 103.7492535" animation-mixer/>'
    }
...
function showGreen(){
    if (document.getElementById('greenOff')){
        ...
        document.getElementById('greenOff').id = 'green';
        var content = document.getElementById('green')
        content.innerHTML = '<a-entity id="green" gltf-model="./static/3dModels/GLB/location2.glb" scale="0.1 0.1 0.1" gps-projected-entity-place="latitude: 1.4015849; longitude: 103.7492535" animation-mixer/>'
    }
}
