...
function showGreen(){
    if (document.getElementById('greenOff')){
        ...
        document.getElementById('greenOff').id = 'green';
        var content = document.getElementById('green')
        content.innerHTML = '<a-entity id="green" gltf-model=".static/3dModels/gITF/map_pointer_-_animated/scene.gltf" scale="0.0000005 0.0000005 0.0000005" gps-projected-entity-place="latitude: 1.4015849; longitude: 103.7492535" animation-mixer></a-entity>';
    }
}
