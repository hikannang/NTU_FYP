...
function selectGreen(){
    ...
    if (document.getElementById('greenOff')){ 
        ...
        content.innerHTML = '<a-entity id="green" gltf-model="./static/3dModels/GLB/navigation_pin.glb" look-at="[gps-projected-camera]" scale="5 5 5" gps-projected-entity-place="latitude: 1.4015849; longitude: 103.7492535" animation-mixer/>'
    }
