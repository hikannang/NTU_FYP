  ...
  try {
    ...
    try {
      ...
      console.log(
        ...
        testDoc.exists()
          ? "Successful"
          : "Document not found but connection worked"
      );
    } catch (dbError) {
    ...
    // 1. Retrieve the booking document using the bookingId from the URL
    ...
    if (!carType || !carId) {
      console.warn("⚠️ Missing car_type or car_id in booking:", {
        carId,
        carType,
      });
      return;
